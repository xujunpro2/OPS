			...
			<el-col :span="16" style="height:99%">
				<el-card class="box-card" style="height:100%" :body-style="fullCardBody">
					<div slot="header" class="clearfix">
					    ...
					    <el-table :data="devTable"  style="width: 100%;">
                            ...
                            <el-table-column prop="devState" label="状态"></el-table-column>
                            <el-table-column prop="spaceId" label="空间"></el-table-column>
